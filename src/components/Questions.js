...
import './Questions.css'; // Make sure the path is correct for your CSS file
import MyAccordion from './Accordation';
...
const Questions = () => {
  ...
  <div class="text1">What’s on your mind</div>
  <div class="text2">Ask Questions</div>
  <svg className='vector-a' width="491" height="475" viewBox="0 0 491 475" fill="none" xmlns="http://www.w3.org/2000/svg">
